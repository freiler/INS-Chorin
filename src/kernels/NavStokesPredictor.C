...
#include "NavStokesPredictor.h"
#include "MooseMesh.h"

registerMooseObject("AirfoilAppApp", NavStokesPredictor);

InputParameters
NavStokesPredictor::validParams()
{
...
NavStokesPredictor::NavStokesPredictor(const InputParameters & parameters)
  : Kernel(parameters),
...
Real
NavStokesPredictor::computeQpResidual()
{
...
Real
NavStokesPredictor::computeQpJacobian()
{
...
Real
NavStokesPredictor::computeQpOffDiagJacobian(unsigned jvar)
{
